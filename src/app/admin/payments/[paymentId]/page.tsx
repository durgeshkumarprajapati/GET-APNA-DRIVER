    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="bg-[#181c24] border border-[#262a33] rounded-2xl p-6 shadow-xl space-y-4">
        ...
        <Row
          label="Captured at"
          value={
            payment.capturedAt ? new Date(payment.capturedAt).toLocaleString() : 'Not yet captured'
          }
        />
      </div>
      ...
      {isRefundable && (
        <div className="bg-[#181c24] border border-[#262a33] rounded-2xl p-6 shadow-xl space-y-4">
          ...
          <div className="space-y-3">
            ...
            {refundMessage && <p className="text-sm text-[#bccac0] text-center">{refundMessage}</p>}
          </div>
        </div>
      )}
    </div>
