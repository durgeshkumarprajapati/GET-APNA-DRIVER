      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        {reconcileFeedback && (
          <div className="p-4 rounded-xl bg-[#00311f] border border-[#25a475] text-[#68dba9] text-xs">
            <strong>Reconciliation Complete:</strong> Inspected {reconcileFeedback.inspected}{' '}
            payments | Captured: {reconcileFeedback.captured} | Failed: {reconcileFeedback.failed} |
            Unchanged: {reconcileFeedback.unchanged}
          </div>
        )}
