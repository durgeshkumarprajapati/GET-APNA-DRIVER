...
export default function TaxInvoicesPage() {
  ...
  return (
    <div className="flex flex-col gap-6 w-full">
      ...
      <div className="bg-[#0a0e16] p-4 rounded-xl border border-[#262a33] font-mono text-xs text-[#bccac0] flex flex-col sm:flex-row sm:items-center justify-between gap-2">
          ...
          <div className="bg-[#1c2028] border border-[#3d4a42] rounded-2xl p-6 max-w-xl w-full space-y-5 shadow-2xl font-mono text-xs text-[#dfe2ee]">
            ...
            <div className="grid grid-cols-2 gap-4 bg-[#0a0e16] p-4 rounded-xl border border-[#262a33]">
              <div className="min-w-0">
                ...
                <div className="font-bold text-[#68dba9] break-words">
                  {selectedInvoice.supplierSnapshot.name}
                </div>
                <div className="text-[10px] text-[#bccac0] break-words">
