...
export const GET = withPermission(PERMISSIONS.ADMIN_INCIDENT_READ, async (request: NextRequest) => {
  try {
    ...
    const [totalActive, totalCritical, totalRecovering, totalEscalated, totalResolvedToday] =
      await Promise.all([
