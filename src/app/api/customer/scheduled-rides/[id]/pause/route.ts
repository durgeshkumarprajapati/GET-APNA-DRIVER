...
import { pauseScheduledRide } from '@/modules/scheduled-rides/application/scheduled-ride-service';
...
export const POST = withPermission<RouteParams>(
  ...
  async (_req, { principal }, routeContext) => {
    try {
      ...
      const message = err instanceof Error ? err.message : 'Failed to pause scheduled ride';
