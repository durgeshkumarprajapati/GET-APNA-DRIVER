      ...
      >
        <button
          ...
          style={{
            ...
            borderBottom:
              activeTab === 'profile' ? '3px solid var(--color-primary)' : '3px solid transparent',
          }}
        >
          Personal Profile
        </button>
        ...
        <button
          ...
          style={{
            ...
            cursor: 'pointer',
            color:
              activeTab === 'preferences' ? 'var(--color-primary)' : 'var(--color-text-secondary)',
            borderBottom:
            ...
            >
              {locations.map((loc) => (
                ...
                >
                  ...
                  >
                    <h3 style={{ margin: 0, fontSize: '1.1rem', fontWeight: 600 }}>{loc.label}</h3>
                    {loc.isDefault && (
                      <span
                        style={{
