            ...
            <div className="flex flex-col gap-3" id="registration-form-panel">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-7 bg-[#1c2028] p-6 sm:p-8 rounded-2xl border border-[#262a33] shadow-lg flex flex-col gap-6">
                  ...
                  {/* GOOGLE SIGN-UP — same /api/auth/google flow as /login; role
                      selection happens after Google authenticates you, not here. */}
                  <a
                    href="/api/auth/google"
                    className="w-full min-h-[48px] py-2.5 px-4 bg-[#0a0e16] hover:bg-[#262a33] rounded-lg font-mono text-xs uppercase tracking-wider text-[#dfe2ee] transition-all flex items-center justify-center gap-3 border border-[#262a33]"
                  >
                  ...
                  <div className="relative my-1 text-center">
                    ...
                    <span className="relative bg-[#1c2028] px-3 font-mono text-[10px] uppercase tracking-wider text-[#87948b]">
