        ...
        await createNotification(
          {
            ...
            body: 'A professional driver has accepted your booking and is preparing for pickup.',
            data: { bookingId },
        ...
        await createNotification(
          {
            ...
            body: 'Booking assignment confirmed. Tap to navigate to pickup location.',
            data: { bookingId },
      ...
      await createNotification(
        {
          ...
          title: 'Driver Service Started',
          body: 'Your driver service has started. Enjoy a safe and pleasant experience with Get Apna Driver.',
          data: { bookingId },
        ...
        await createNotification(
          {
            ...
            body: 'Booking completed successfully. Earnings credited to your driver wallet.',
            data: { bookingId },
        ...
        await createNotification(
          {
            ...
            body: `Payment of ₹${amount} for your booking has been confirmed.`,
          ...
          await createNotification(
            {
              ...
              body: 'This booking was reassigned by our operations team. You have been released back to available status.',
              data: { bookingId },
          ...
          await createNotification(
            {
              ...
              type: NotificationType.SYSTEM_ANNOUNCEMENT,
              title: 'Booking Assignment Confirmed',
              body: 'Our operations team has assigned you to a booking. Tap to view details.',
              data: { bookingId },
          ...
          await createNotification(
            {
              ...
              body: `The booking you were assigned to was cancelled by operations support. You are now available for new offers.`,
              data: { bookingId, reason },
      ...
      await createNotification(
        {
          ...
          body: `A customer rated your recent booking ${rating} out of 5 stars.`,
      ...
      await createNotification(
        {
          ...
          body: 'Great news! Your referred friend completed their qualifying booking.',
          actionUrl: '/customer/referral',
      ...
      await createNotification(
        {
          ...
          body: `Your booking scheduled for ${time || 'upcoming time'} has been saved.`,
      ...
      await createNotification(
        {
          ...
          title: 'Upcoming Scheduled Booking',
